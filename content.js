  ...
  obras: [
    {
      ...
      complemento_titulo: "serie opuestos",
    ...
    {
      titulo: "KIEP 1.0",
      complemento_titulo: "Budismo Cuántico",
      exposicion: "",
      año: "2025",
      descripcion: "KIEP (Budismo Cuántico) son grupos de 4 piezas inspiradas en principios budistas. Principios que se conectan con ideas universales de diferentes culturas y religiones, y que se entrelazan a su vez con el misterioso mundo atómico.",
      descripcion_extras: [
        "<strong>Karma:</strong> Esa causa y efecto de cada acción que se va entretejiendo en el tiempo y el espacio y que nos encuentra a cada momento cruzando situaciones grabadas en la memoria de nuestro histórico colectivo. Es ese comportamiento atómico de superposiciones y entrelazamientos donde un evento en una partícula inevitablemente influye en el estado de otra, sin importar el tiempo o la distancia.",
        "<strong>Impermanencia:</strong> Donde todo es transitorio, nada es estático. No se puede esperar una constante en un mundo en movimiento. Así como toda partícula subatómica, donde su estado y ubicación no son mas que probabilidades, así es la vida misma.",
        "<strong>Ego:</strong> Esa ilusión del yo, una imagen creada por nuestros recuerdos, vivencias y experiencias acumuladas que nos hacen creer que somos un ser único, sólido y permanente. Una imagen que pretende, sin lograrlo, separarnos del todo. Somos una estructura de partículas atómicas que se encuentran para crear ese ser que percibimos y el entorno en el que convivimos.",
        "<strong>Presente:</strong> Es el único momento donde se pude percibir la experiencia humana. La atención plena (mindfulness) implica observar las sensaciones, pensamientos y emociones sin apegarse a ellos, reconociendo su naturaleza transitoria. Dejar el pasado y no divagar en el futuro. La aceptación de nuestra realidad es estar presentes. El presente es esa partícula atómica, que solo permite determinar su estado mediante la observación, mirándose a sí misma."
      ],
    ...
    },
    {
      ...
      exposicion: "",
      año: "2025",
      descripcion: "naturAI 3.0 simboliza un intercambio de señales, datos e información que forman lo que vemos, lo que definimos, lo que creamos y lo que será creado por la futura AI. La réplica de la naturaleza nos ha motivado por siglos, y se han creado imágenes y objetos a través del arte, la ingeniería y la ciencia que buscan ser tan perfectos como la naturaleza en sí – con la capacidad futura de la AI es imaginable que estas réplicas lleguen a ser casi imperceptibles – mis objetos juegan con esa incertidumbre mezclando naturaleza, dibujos e imágenes generadas por la AI.",
      imgs: ["NaturAI-1.0-foto_02.jpeg"],
      videos: [],
      links: []
    },
    {
      titulo: "the gift 1.0",
      complemento_titulo: "obra personal",
      exposicion: "",
      año: "2025",
    ...
    },
    {
      ...
      exposicion: "",
      año: "2025",
      descripcion: "naturAI 2.0 es el híbrido entre lo que conocemos como naturaleza, sus réplicas humanas y las futuras representaciones de la misma creadas por la AI. La réplica de la naturaleza nos ha motivado por siglos, y se han creado imágenes y objetos a través del arte, la ingeniería y la ciencia que buscan ser tan perfectos como la naturaleza en sí – con la capacidad futura de la AI es imaginable que estas réplicas lleguen a ser casi imperceptibles – mis objetos juegan con esa incertidumbre mezclando naturaleza, dibujos e imágenes generadas por la AI.",
      imgs: ["naturAI-2.0-e1759186674988-1018x1024.jpg"],
      videos: [],
      links: []
    },
    {
      ...
      exposicion: "",
      año: "2025",
      descripcion: "naturAI 1.0 es la incertidumbre que nos espera al momento de ver algo considerado naturaleza y no tener certeza si su creación ha sido un proceso natural, obra del hombre o caprichos de la AI. Posiblemente sea una futura simbiosis donde todo a la final es lo mismo. La réplica de la naturaleza nos ha motivado por siglos, y se han creado imágenes y objetos a través del arte, la ingeniería y la ciencia que buscan ser tan perfectos como la naturaleza en sí – con la capacidad futura de la AI es imaginable que estas réplicas lleguen a ser casi imperceptibles – mis objetos juegan con esa incertidumbre mezclando naturaleza, dibujos e imágenes generadas por la AI.",
  ...
  expo_list: [
    {
      ...
      imgs: ["opuestos_1_final-1024x1024.jpg", "opuestos_3-1024x1024.jpeg", "contrarios_1_final-1024x1024.jpg", "contrarios_2_final-1024x1024.jpg"],
      videos: [],
      links: [
